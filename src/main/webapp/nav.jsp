...
<nav class="navbar">
    ...
    <ul class="nav-links">
        ...
        <li><a href="matches.jsp" class="<%= currentPage.equals("matches") ? "active" : "" %>">Matches</a></li>
        <li><a href="standings.jsp" class="<%= currentPage.equals("standings") ? "active" : "" %>">Standings</a></li>
        <li><a href="teams.jsp" class="<%= currentPage.equals("teams") ? "active" : "" %>">Teams</a></li>
        <li><a href="venues.jsp" class="<%= currentPage.equals("venues") ? "active" : "" %>">Venues</a></li>
